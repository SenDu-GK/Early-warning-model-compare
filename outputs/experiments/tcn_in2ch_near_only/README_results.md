...
- Event date: 2018-03-09
- Last observed InSAR epoch: 2018-02-25 (D20180225)
- Near-event window: last H=5 epochs before last observation
- Near-event epoch range: D20171227 to D20180213
...
- The model is trained so core points are positive only near the end (near-event window).
...
- Last observed epoch date in the data: 2018-02-25
